...
public class OpenRouterService {
    ...
    private final String[] modelos = {
            "google/gemma-4-26b-a4b-it:free",// 1er intento
            "google/gemma-4-31b-it:free",// 2to intento
            "cohere/north-mini-code:free",// 3er intento
            "nvidia/nemotron-3.5-lightning:free",// 4to intento
            "nvidia/nemotron-3-ultra-550b-a55b:free",// 5to intento
            "openai/gpt-4o-mini",// 6to intento
